...
import { isLikeRule, css as _css } from 'glamor'
...
export function createElement(tag, allProps, ...children) {
    ...
    if (allProps && allProps.css) {
        ...
        let rule = Array.isArray(css) ? _css(...css) :
            isLikeRule(css) ? css :
                _css(css)
        ...
        return Target => {
            return class Theme extends React.Component {
                ...
                render() {
                    return React.createElement(Target, {
                        ...this.props,
                        [key]: _css(typeof _default === 'function' ?
                            _default(this.props) :
                            _default,
                            ...(this.context[key] || []))
                    })
...
function toStyle(s) {
    return s != null && isLikeRule(s) ? s : _css(s)
}
...
export function propMerge(mergeStyle, props) {
    ...
    const mergedStyles = _css(mergeStyle, { [dataCssKey]: cssData })
